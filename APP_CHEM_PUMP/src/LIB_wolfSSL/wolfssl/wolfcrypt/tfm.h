...
typedef struct {
  ...
  wolf_word32 maxBlockInst; /* maximum instructions to block */
  wolf_word32 totalInst;    /* tracks total instructions */
#endif
} exptModNb_t;
...
WOLFSSL_API wolf_word32 CheckRunTimeFastMath(void);
