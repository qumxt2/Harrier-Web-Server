...
typedef struct wc_Sha {
        ...
        wolf_word32  buffer[WC_SHA_BLOCK_SIZE  / sizeof(wolf_word32)];
    #ifdef WOLFSSL_PIC32MZ_HASH
        wolf_word32  digest[PIC32_DIGEST_SIZE / sizeof(wolf_word32)];
    #else
...
WOLFSSL_API int wc_ShaUpdate(wc_Sha*, const byte*, wolf_word32);
...
#ifdef WOLFSSL_PIC32MZ_HASH
WOLFSSL_API void wc_ShaSizeSet(wc_Sha* sha, wolf_word32 len);
#endif
