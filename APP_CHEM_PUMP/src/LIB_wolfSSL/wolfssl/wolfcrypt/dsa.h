...
WOLFSSL_API int wc_DsaPublicKeyDecode(const byte* input, wolf_word32* inOutIdx,
                                      DsaKey*, wolf_word32);
WOLFSSL_API int wc_DsaPrivateKeyDecode(const byte* input, wolf_word32* inOutIdx,
                                       DsaKey*, wolf_word32);
WOLFSSL_API int wc_DsaKeyToDer(DsaKey* key, byte* output, wolf_word32 inLen);
...
WOLFSSL_API int wc_DsaExportParamsRaw(DsaKey* dsa, byte* p, wolf_word32* pSz,
                                      byte* q, wolf_word32* qSz, byte* g,
                                      wolf_word32* gSz);
WOLFSSL_API int wc_DsaExportKeyRaw(DsaKey* dsa, byte* x, wolf_word32* xSz, byte* y,
                                   wolf_word32* ySz);
#ifdef __cplusplus
    } /* extern "C" */
#endif
