...
typedef struct wc_Sha256 {
    ...
    ALIGN16 wolf_word32  digest[WC_SHA256_DIGEST_SIZE / sizeof(wolf_word32)];
    ALIGN16 wolf_word32  buffer[WC_SHA256_BLOCK_SIZE  / sizeof(wolf_word32)];
    wolf_word32  buffLen;   /* in bytes          */
    wolf_word32  loLen;     /* length in bytes   */
    wolf_word32  hiLen;     /* length in bytes   */
    void*   heap;
...
WOLFSSL_API int wc_Sha256Update(wc_Sha256*, const byte*, wolf_word32);
...
#ifdef WOLFSSL_PIC32MZ_HASH
WOLFSSL_API void wc_Sha256SizeSet(wc_Sha256*, wolf_word32);
#endif
...
WOLFSSL_API int wc_Sha224Update(wc_Sha224*, const byte*, wolf_word32);
