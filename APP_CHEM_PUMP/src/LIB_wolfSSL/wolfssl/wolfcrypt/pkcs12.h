...
WOLFSSL_API int wc_d2i_PKCS12(const byte* der, wolf_word32 derSz, WC_PKCS12* pkcs12);
WOLFSSL_API int wc_PKCS12_parse(WC_PKCS12* pkcs12, const char* psw,
        byte** pkey, wolf_word32* pkeySz, byte** cert, wolf_word32* certSz,
        WC_DerCertList** ca);
WOLFSSL_API WC_PKCS12* wc_PKCS12_create(char* pass, wolf_word32 passSz,
        char* name, byte* key, wolf_word32 keySz, byte* cert, wolf_word32 certSz,
