...
typedef struct EncryptedInfo {
    ...
    int      cipherType;
    wolf_word32   keySz;
    wolf_word32   ivSz;             /* salt or encrypted IV size */
...
WOLFSSL_API int wc_MakeCert_ex(Cert* cert, byte* derBuffer, wolf_word32 derSz,
                                int keyType, void* key, WC_RNG* rng);
WOLFSSL_API int wc_MakeCert(Cert*, byte* derBuffer, wolf_word32 derSz, RsaKey*,
                             ecc_key*, WC_RNG*);
#ifdef WOLFSSL_CERT_REQ
    WOLFSSL_API int wc_MakeCertReq_ex(Cert*, byte* derBuffer, wolf_word32 derSz,
                                       int, void*);
    WOLFSSL_API int wc_MakeCertReq(Cert*, byte* derBuffer, wolf_word32 derSz,
                                    RsaKey*, ecc_key*);
#endif
WOLFSSL_API int wc_SignCert_ex(int requestSz, int sType, byte* buffer,
                                wolf_word32 buffSz, int keyType, void* key,
                                WC_RNG* rng);
WOLFSSL_API int wc_SignCert(int requestSz, int sigType, byte* derBuffer,
                             wolf_word32 derSz, RsaKey*, ecc_key*, WC_RNG*);
WOLFSSL_API int wc_MakeSelfCert(Cert*, byte* derBuffer, wolf_word32 derSz, RsaKey*,
                             WC_RNG*);
 ...
 */
WOLFSSL_API int wc_SetExtKeyUsageOID(Cert *cert, const char *oid, wolf_word32 sz,
                                     byte idx, void* heap);
#endif /* WOLFSSL_EKU_OID */
#endif /* WOLFSSL_CERT_EXT */

    #ifdef HAVE_NTRU
        WOLFSSL_API int wc_MakeNtruCert(Cert*, byte* derBuffer, wolf_word32 derSz,
...
WOLFSSL_API  int wc_AllocDer(DerBuffer** pDer, wolf_word32 length, int type, void* heap);
WOLFSSL_API void wc_FreeDer(DerBuffer** pDer);
    ...
    WOLFSSL_API int wc_DerToPem(const byte* der, wolf_word32 derSz, byte* output,
                                wolf_word32 outputSz, int type);
    WOLFSSL_API int wc_DerToPemEx(const byte* der, wolf_word32 derSz, byte* output,
                                wolf_word32 outputSz, byte *cipherIno, int type);
#endif

#if !defined(NO_RSA) && !defined(HAVE_USER_RSA)
    WOLFSSL_API int wc_RsaPublicKeyDecode_ex(const byte* input, wolf_word32* inOutIdx,
        wolf_word32 inSz, const byte** n, wolf_word32* nSz, const byte** e, wolf_word32* eSz);
#endif

#ifdef HAVE_ECC
    /* private key helpers */
    WOLFSSL_API int wc_EccPrivateKeyDecode(const byte*, wolf_word32*,
                                           ecc_key*, wolf_word32);
    WOLFSSL_API int wc_EccKeyToDer(ecc_key*, byte* output, wolf_word32 inLen);
    ...
    /* public key helper */
    WOLFSSL_API int wc_EccPublicKeyDecode(const byte*, wolf_word32*,
                                              ecc_key*, wolf_word32);
    WOLFSSL_API int wc_EccPublicKeyToDer(ecc_key*, byte* output,
                                         wolf_word32 inLen, int with_AlgCurve);
#endif

#ifdef HAVE_ED25519
    /* private key helpers */
    WOLFSSL_API int wc_Ed25519PrivateKeyDecode(const byte*, wolf_word32*,
                                               ed25519_key*, wolf_word32);
    ...
    /* public key helper */
    WOLFSSL_API int wc_Ed25519PublicKeyDecode(const byte*, wolf_word32*,
                                              ed25519_key*, wolf_word32);
...
WOLFSSL_API wolf_word32 wc_EncodeSignature(byte* out, const byte* digest,
                                      wolf_word32 digSz, int hashOID);
WOLFSSL_API int wc_GetCTC_HashOID(int type);

WOLFSSL_API int wc_GetPkcs8TraditionalOffset(byte* input,
                                             wolf_word32* inOutIdx, wolf_word32 sz);
WOLFSSL_API int wc_CreatePKCS8Key(byte* out, wolf_word32* outSz,
       byte* key, wolf_word32 keySz, int algoID, const byte* curveOID, wolf_word32 oidSz);
 ...
 * Example:
    long lTime;
    rc = wc_GetTime(&lTime, (wolf_word32)sizeof(lTime));
*/
WOLFSSL_API int wc_GetTime(void* timePtr, wolf_word32 timeSize);
#endif
...
typedef struct _wc_CertPIV {
    ...
    wolf_word32       certErrDetSz;
    const byte*  nonce;         /* Identiv Only */
    wolf_word32       nonceSz;       /* Identiv Only */
    const byte*  signedNonce;   /* Identiv Only */
    wolf_word32       signedNonceSz; /* Identiv Only */
...
WOLFSSL_API int wc_ParseCertPIV(wc_CertPIV* cert, const byte* buf, wolf_word32 totalSz);
