...
typedef struct HC128 {
    wolf_word32 T[1024];             /* P[i] = T[i];  Q[i] = T[1024 + i ]; */
    wolf_word32 X[16];
    wolf_word32 Y[16];
    wolf_word32 counter1024;         /* counter1024 = i mod 1024 at the ith step */
    wolf_word32 key[8];
    wolf_word32 iv[8];
#ifdef XSTREAM_ALIGN
...
WOLFSSL_API int wc_Hc128_Process(HC128*, byte*, const byte*, wolf_word32);
