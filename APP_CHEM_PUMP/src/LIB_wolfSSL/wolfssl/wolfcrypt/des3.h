...
typedef struct Des {
    wolf_word32 reg[DES_BLOCK_SIZE / sizeof(wolf_word32)];      /* for CBC mode */
    wolf_word32 tmp[DES_BLOCK_SIZE / sizeof(wolf_word32)];      /* same         */
    wolf_word32 key[DES_KS_SIZE];
} Des;


/* DES3 encryption and decryption */
typedef struct Des3 {
    wolf_word32 key[3][DES_KS_SIZE];
    wolf_word32 reg[DES_BLOCK_SIZE / sizeof(wolf_word32)];      /* for CBC mode */
    wolf_word32 tmp[DES_BLOCK_SIZE / sizeof(wolf_word32)];      /* same         */
#ifdef WOLFSSL_ASYNC_CRYPT
    const byte* key_raw;
