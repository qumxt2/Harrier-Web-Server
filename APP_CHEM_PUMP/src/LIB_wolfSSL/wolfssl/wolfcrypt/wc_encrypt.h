...
WOLFSSL_API int wc_AesCbcEncryptWithKey(byte* out, const byte* in, wolf_word32 inSz,
                                        const byte* key, wolf_word32 keySz,
                                        const byte* iv);
WOLFSSL_API int wc_AesCbcDecryptWithKey(byte* out, const byte* in, wolf_word32 inSz,
                                        const byte* key, wolf_word32 keySz,
                                        const byte* iv);
#endif /* !NO_AES */
...
WOLFSSL_API int wc_Des3_CbcDecryptWithKey(byte* out,
    ...
    WOLFSSL_API int wc_BufferKeyDecrypt(struct EncryptedInfo* info, byte* der, wolf_word32 derSz,
        const byte* password, int passwordSz, int hashType);
    WOLFSSL_API int wc_BufferKeyEncrypt(struct EncryptedInfo* info, byte* der, wolf_word32 derSz,
        const byte* password, int passwordSz, int hashType);
