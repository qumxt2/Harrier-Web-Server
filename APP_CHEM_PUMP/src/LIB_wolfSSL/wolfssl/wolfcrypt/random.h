...
WOLFSSL_API int  wc_InitRngNonce(WC_RNG* rng, byte* nonce, wolf_word32 nonceSz);
WOLFSSL_API int  wc_InitRngNonce_ex(WC_RNG* rng, byte* nonce, wolf_word32 nonceSz,
                                    void* heap, int devId);
WOLFSSL_API int  wc_RNG_GenerateBlock(WC_RNG*, byte*, wolf_word32 sz);
...
#define wc_FreeRng(rng) (void)NOT_COMPILED_IN
    ...
    WOLFSSL_LOCAL int wc_RNG_DRBG_Reseed(WC_RNG* rng, const byte* entropy,
                                        wolf_word32 entropySz);
    WOLFSSL_API int wc_RNG_TestSeed(const byte* seed, wolf_word32 seedSz);
    WOLFSSL_API int wc_RNG_HealthTest(int reseed,
                                        const byte* entropyA, wolf_word32 entropyASz,
                                        const byte* entropyB, wolf_word32 entropyBSz,
