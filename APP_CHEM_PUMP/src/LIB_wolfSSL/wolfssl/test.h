...
#define TEST_BUFFER_SIZE 16384
    ...
    static WC_INLINE wolf_word32 min(wolf_word32 a, wolf_word32 b)
    {
        return a > b ? b : a;
    }
...
static WC_INLINE void OCSPRespFreeCb(void* ioCtx, unsigned char* response)
{
    ...
    static WC_INLINE int load_key_file(const char* fname, byte** derBuf, wolf_word32* derLen)
    {
        int ret;
        byte* buf = NULL;
        size_t bufLen;
        ...
        *derBuf = (byte*)malloc(bufLen);
        ...
        ret = wc_KeyPemToDer(buf, (wolf_word32)bufLen, *derBuf, (wolf_word32)bufLen, NULL);
        if (ret < 0) {
            free(buf);
            free(*derBuf);
            return ret;
...
static WC_INLINE int myEccKeyGen(WOLFSSL* ssl, ecc_key* key, wolf_word32 keySz,
    int ecc_curve, void* ctx)
{
    ...
    wolf_word32 qxLen = sizeof(qx), qyLen = sizeof(qy);
...
static WC_INLINE int myEccSign(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
        byte* out, wolf_word32* outSz, const byte* key, wolf_word32 keySz, void* ctx)
{
    int       ret;
    WC_RNG    rng;
    wolf_word32    idx = 0;
...
static WC_INLINE int myEccVerify(WOLFSSL* ssl, const byte* sig, wolf_word32 sigSz,
        const byte* hash, wolf_word32 hashSz, const byte* key, wolf_word32 keySz,
        int* result, void* ctx)
{
    int       ret;
    wolf_word32    idx = 0;
...
#ifdef HAVE_ED25519
static WC_INLINE int myEd25519Sign(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
        byte* out, wolf_word32* outSz, const byte* key, wolf_word32 keySz, void* ctx)
{
    int         ret;
    wolf_word32      idx = 0;
...
static WC_INLINE int myEd25519Verify(WOLFSSL* ssl, const byte* sig, wolf_word32 sigSz,
        const byte* msg, wolf_word32 msgSz, const byte* key, wolf_word32 keySz,
        int* result, void* ctx)
{
    int         ret;
    ed25519_key myKey;
...
static WC_INLINE int myRsaSign(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
        byte* out, wolf_word32* outSz, const byte* key, wolf_word32 keySz, void* ctx)
{
    WC_RNG  rng;
    int     ret;
...
static WC_INLINE int myRsaVerify(WOLFSSL* ssl, byte* sig, wolf_word32 sigSz,
        byte** out, const byte* key, wolf_word32 keySz, void* ctx)
{
    int     ret;
    wolf_word32  idx = 0;
    RsaKey  myKey;
...
static WC_INLINE int myRsaSignCheck(WOLFSSL* ssl, byte* sig, wolf_word32 sigSz,
        byte** out, const byte* key, wolf_word32 keySz, void* ctx)
{
    int     ret;
    wolf_word32  idx = 0;
...
#ifdef WC_RSA_PSS
static WC_INLINE int myRsaPssSign(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
        byte* out, wolf_word32* outSz, int hash, int mgf, const byte* key,
        wolf_word32 keySz, void* ctx)
{
...
static WC_INLINE int myRsaPssVerify(WOLFSSL* ssl, byte* sig, wolf_word32 sigSz,
        byte** out, int hash, int mgf, const byte* key, wolf_word32 keySz, void* ctx)
{
    int       ret;
    wolf_word32    idx = 0;
    RsaKey    myKey;
...
static WC_INLINE int myRsaPssSignCheck(WOLFSSL* ssl, byte* sig, wolf_word32 sigSz,
        byte** out, int hash, int mgf, const byte* key, wolf_word32 keySz, void* ctx)
{
    int       ret;
    wolf_word32    idx = 0;
...
static WC_INLINE int myRsaEnc(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
                           byte* out, wolf_word32* outSz, const byte* key,
                           wolf_word32 keySz, void* ctx)
{
    int       ret;
    wolf_word32    idx = 0;
...
static WC_INLINE int myRsaDec(WOLFSSL* ssl, byte* in, wolf_word32 inSz,
                           byte** out,
                           const byte* key, wolf_word32 keySz, void* ctx)
{
    int       ret;
    wolf_word32    idx = 0;
    RsaKey    myKey;
