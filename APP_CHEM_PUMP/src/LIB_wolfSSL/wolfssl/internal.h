...
#define DTLS_WORD_BITS (sizeof(wolf_word32) * CHAR_BIT)
#define DTLS_SEQ_BITS  (WOLFSSL_DTLS_WINDOW_WORDS * DTLS_WORD_BITS)
#define DTLS_SEQ_SZ    (sizeof(wolf_word32) * WOLFSSL_DTLS_WINDOW_WORDS)
...
/* for sniffer */
WOLFSSL_LOCAL int DoFinished(WOLFSSL* ssl, const byte* input, wolf_word32* inOutIdx,
                            wolf_word32 size, wolf_word32 totalSz, int sniff);
WOLFSSL_LOCAL int DoApplicationData(WOLFSSL* ssl, byte* input, wolf_word32* inOutIdx);
/* TLS v1.3 needs these */
WOLFSSL_LOCAL int  HandleTlsResumption(WOLFSSL* ssl, int bogusID,
                                       Suites* clSuites);
WOLFSSL_LOCAL int  DoClientHello(WOLFSSL* ssl, const byte* input, wolf_word32*,
                                 wolf_word32);
#ifdef WOLFSSL_TLS13
WOLFSSL_LOCAL int DoTls13ClientHello(WOLFSSL* ssl, const byte* input,
                                     wolf_word32* inOutIdx, wolf_word32 helloSz);
#endif
WOLFSSL_LOCAL int  DoServerHello(WOLFSSL* ssl, const byte* input, wolf_word32*,
                                 wolf_word32);
...
WOLFSSL_LOCAL int  ProcessPeerCerts(WOLFSSL* ssl, byte* input, wolf_word32* inOutIdx, wolf_word32 size);
...
typedef struct {
    ...
    wolf_word32 length;       /* total buffer length used */
    wolf_word32 idx;          /* idx to part of length already consumed */
    wolf_word32 bufferSize;   /* current buffer size */
...
typedef struct WOLFSSL_DTLS_PEERSEQ {
    wolf_word32 window[WOLFSSL_DTLS_WINDOW_WORDS];
    ...
    wolf_word32 nextSeq_lo;

    wolf_word32 prevWindow[WOLFSSL_DTLS_WINDOW_WORDS];
                        /* Sliding window for old epoch        */
    wolf_word32 prevSeq_lo;
    word16 prevSeq_hi;  /* Next sequence in allowed old epoch  */

#ifdef WOLFSSL_MULTICAST
    word16 peerId;
    wolf_word32 highwaterMark;
#endif
...
typedef struct Keys {
    ...
    wolf_word32 peer_sequence_number_hi;
    wolf_word32 peer_sequence_number_lo;
    wolf_word32 sequence_number_hi;
    wolf_word32 sequence_number_lo;

#ifdef WOLFSSL_DTLS
    word16 curEpoch;    /* Received epoch in current record    */
    word16 curSeq_hi;   /* Received sequence in current record */
    wolf_word32 curSeq_lo;
#ifdef WOLFSSL_MULTICAST
    ...
    wolf_word32 dtls_sequence_number_lo;
    word16 dtls_prev_sequence_number_hi;        /* Previous epoch */
    wolf_word32 dtls_prev_sequence_number_lo;
    word16 dtls_handshake_number;               /* Current tx handshake seq */
#endif

    wolf_word32 encryptSz;             /* last size of encrypted data   */
    wolf_word32 padSz;                 /* how much to advance after decrypt part */
...
typedef struct TLSX {
    ...
    wolf_word32       val;  /* Extension Value */
...
WOLFSSL_LOCAL void   TLSX_SNI_SetOptions(TLSX* extensions, byte type,
                                                                  byte options);
WOLFSSL_LOCAL int    TLSX_SNI_GetFromBuffer(const byte* buffer, wolf_word32 bufferSz,
                                         byte type, byte* sni, wolf_word32* inOutSz);
#endif
...
WOLFSSL_LOCAL SessionTicket* TLSX_SessionTicket_Create(wolf_word32 lifetime,
...
WOLFSSL_LOCAL int QSH_Decrypt(QSHKey* key, byte* in, wolf_word32 szIn,
...
typedef struct KeyShareEntry {
    ...
    wolf_word32                keLen;     /* Key exchange data length */
    void*                 key;       /* Private key              */
    wolf_word32                keyLen;    /* Private key length       */
    byte*                 pubKey;    /* Public key               */
    wolf_word32                pubKeyLen; /* Public key length        */
...
typedef struct PreSharedKey {
    ...
    wolf_word32               ticketAge;               /* Age of the ticket  */
    byte                 cipherSuite0;            /* Cipher Suite       */
    byte                 cipherSuite;             /* Cipher Suite       */
    wolf_word32               binderLen;               /* Length of HMAC     */
...
WOLFSSL_LOCAL int TLSX_PreSharedKey_Use(WOLFSSL* ssl, byte* identity,
                                        word16 len, wolf_word32 age, byte hmac,
...
#ifdef WOLFSSL_EARLY_DATA
WOLFSSL_LOCAL int TLSX_EarlyData_Use(WOLFSSL* ssl, wolf_word32 max);
#endif
...
struct WOLFSSL_CTX {
    ...
    wolf_word32            disabledCurves;   /* curves disabled by user */
    ...
    wolf_word32          timeout;            /* session timeout */
#if defined(HAVE_ECC) || defined(HAVE_CURVE25519)
    wolf_word32          ecdhCurveOID;       /* curve Ecc_Sum */
#endif
#ifdef HAVE_ECC
    word16          eccTempKeySz;       /* in octets 20 - 66 */
#endif
#if defined(HAVE_ECC) || defined(HAVE_ED25519)
    wolf_word32          pkCurveOID;         /* curve Ecc_Sum */
#endif
#if defined(HAVE_SESSION_TICKET) || !defined(NO_PSK)
    ...
    wolf_word32      mcastFirstSeq;    /* first trigger level */
    wolf_word32      mcastSecondSeq;   /* second tigger level */
    wolf_word32      mcastMaxSeq;      /* max level */
#endif
#ifdef HAVE_OCSP
    WOLFSSL_OCSP      ocsp;
#endif
...
struct WOLFSSL_SESSION {
    wolf_word32             bornOn;                    /* create time in seconds   */
    wolf_word32             timeout;                   /* timeout in seconds       */
...
#if defined(HAVE_SESSION_TICKET) || !defined(NO_PSK)
    #ifdef WOLFSSL_TLS13
    wolf_word32             ticketSeen;                /* Time ticket seen (ms) */
    wolf_word32             ticketAdd;                 /* Added by client */
        #ifndef WOLFSSL_TLS13_DRAFT_18
...
typedef int (*hmacfp) (WOLFSSL*, byte*, const byte*, wolf_word32, int, int, int);
...
typedef struct Arrays {
    ...
    wolf_word32          preMasterSz;        /* differs for DH, actual size */
    wolf_word32          pendingMsgSz;       /* defrag buffer size */
    wolf_word32          pendingMsgOffset;   /* current offset into defrag buffer */
#if defined(HAVE_SESSION_TICKET) || !defined(NO_PSK)
    wolf_word32          psk_keySz;          /* actual size */
...
struct WOLFSSL_X509 {
    ...
    const byte*      CRLInfo;
    byte*            authInfo;
    wolf_word32           pathLength;
    word16           keyUsage;
    int              CRLInfoSz;
    int              authInfoSz;
    wolf_word32           authKeyIdSz;
    wolf_word32           subjKeyIdSz;
    wolf_word32           extKeyUsageSz;
    wolf_word32           extKeyUsageCount;
...
typedef struct DtlsMsg {
    ...
    byte*           msg;
    DtlsFrag*       fragList;
    wolf_word32          fragSz;    /* Length of fragments received */
    wolf_word32          seq;       /* Handshake sequence number    */
    wolf_word32          sz;        /* Length of whole message      */
    byte            type;
} DtlsMsg;
...
typedef struct HS_Hashes {
    ...
    struct WOLFSSL_ASYNC {
        ...
        wolf_word32        args[MAX_ASYNC_ARGS]; /* holder for current args */
    };
#endif
...
struct WOLFSSL {
    ...
    wolf_word32          hsType;             /* Type of Handshake key (hsKey) */
    ...
    wolf_word32          timeout;            /* session timeout */
    wolf_word32          fragOffset;         /* fragment offset */
    word16          curSize;
    byte            verifyDepth;
    ...
    wolf_word32          dtls_tx_msg_list_sz;
    wolf_word32          dtls_rx_msg_list_sz;
    DtlsMsg*        dtls_tx_msg_list;
    DtlsMsg*        dtls_rx_msg_list;
    void*           IOCB_CookieCtx;     /* gen cookie ctx */
    wolf_word32          dtls_expected_rx;
#ifdef WOLFSSL_SESSION_EXPORT
    ...
    wolf_word32 macDropCount;
    wolf_word32 replayDropCount;
...
WOLFSSL_LOCAL int DoClientTicket(WOLFSSL*, const byte*, wolf_word32);
...
WOLFSSL_LOCAL int SetTicket(WOLFSSL*, const byte*, wolf_word32);
WOLFSSL_LOCAL int wolfSSL_GetMaxRecordSize(WOLFSSL* ssl, int maxFragment);

#ifndef NO_CERTS
    #ifndef NO_RSA
        #ifdef WC_RSA_PSS
            WOLFSSL_LOCAL int CheckRsaPssPadding(const byte* plain, wolf_word32 plainSz,
                byte* out, wolf_word32 sigSz, enum wc_HashType hashType);
        ...
        WOLFSSL_LOCAL int VerifyRsaSign(WOLFSSL* ssl, byte* verifySig,
            wolf_word32 sigSz, const byte* plain, wolf_word32 plainSz, int sigAlgo,
            int hashAlgo, RsaKey* key, DerBuffer* keyBufInfo);
        WOLFSSL_LOCAL int RsaSign(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
            byte* out, wolf_word32* outSz, int sigAlgo, int hashAlgo, RsaKey* key,
            DerBuffer* keyBufInfo);
        WOLFSSL_LOCAL int RsaVerify(WOLFSSL* ssl, byte* in, wolf_word32 inSz,
            byte** out, int sigAlgo, int hashAlgo, RsaKey* key,
            buffer* keyBufInfo);
        WOLFSSL_LOCAL int RsaDec(WOLFSSL* ssl, byte* in, wolf_word32 inSz, byte** out,
            wolf_word32* outSz, RsaKey* key, DerBuffer* keyBufInfo);
        WOLFSSL_LOCAL int RsaEnc(WOLFSSL* ssl, const byte* in, wolf_word32 inSz, byte* out,
            wolf_word32* outSz, RsaKey* key, buffer* keyBufInfo);
    #endif /* !NO_RSA */

    #ifdef HAVE_ECC
        WOLFSSL_LOCAL int EccSign(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
            byte* out, wolf_word32* outSz, ecc_key* key, DerBuffer* keyBufInfo);
        WOLFSSL_LOCAL int EccVerify(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
            const byte* out, wolf_word32 outSz, ecc_key* key, buffer* keyBufInfo);
        WOLFSSL_LOCAL int EccSharedSecret(WOLFSSL* ssl, ecc_key* priv_key,
            ecc_key* pub_key, byte* pubKeyDer, wolf_word32* pubKeySz, byte* out,
            wolf_word32* outlen, int side);
    #endif /* HAVE_ECC */
    #ifdef HAVE_ED25519
        WOLFSSL_LOCAL int Ed25519CheckPubKey(WOLFSSL* ssl);
        WOLFSSL_LOCAL int Ed25519Sign(WOLFSSL* ssl, const byte* in, wolf_word32 inSz,
            byte* out, wolf_word32* outSz, ed25519_key* key, DerBuffer* keyBufInfo);
        WOLFSSL_LOCAL int Ed25519Verify(WOLFSSL* ssl, const byte* in,
            wolf_word32 inSz, const byte* msg, wolf_word32 msgSz, ed25519_key* key,
            buffer* keyBufInfo);
    #endif /* HAVE_ED25519 */
...
WOLFSSL_LOCAL  int GrowInputBuffer(WOLFSSL* ssl, int size, int usedLength);
    ...
    WOLFSSL_LOCAL int  TLS_hmac(WOLFSSL* ssl, byte* digest, const byte* in,
                                wolf_word32 sz, int padSz, int content, int verify);
#endif
#endif
...
#ifdef WOLFSSL_DTLS
    WOLFSSL_LOCAL DtlsMsg* DtlsMsgNew(wolf_word32, void*);
    WOLFSSL_LOCAL void DtlsMsgDelete(DtlsMsg*, void*);
    WOLFSSL_LOCAL void DtlsMsgListDelete(DtlsMsg*, void*);
    WOLFSSL_LOCAL int  DtlsMsgSet(DtlsMsg*, wolf_word32, const byte*, byte,
                                                       wolf_word32, wolf_word32, void*);
    WOLFSSL_LOCAL DtlsMsg* DtlsMsgFind(DtlsMsg*, wolf_word32);
    WOLFSSL_LOCAL void DtlsMsgStore(WOLFSSL*, wolf_word32, const byte*, wolf_word32,
                                                byte, wolf_word32, wolf_word32, void*);
    WOLFSSL_LOCAL DtlsMsg* DtlsMsgInsert(DtlsMsg*, DtlsMsg*);

    WOLFSSL_LOCAL int  DtlsMsgPoolSave(WOLFSSL*, const byte*, wolf_word32);
    WOLFSSL_LOCAL int  DtlsMsgPoolTimeout(WOLFSSL*);
    WOLFSSL_LOCAL int  VerifyForDtlsMsgPoolSend(WOLFSSL*, byte, wolf_word32);
    ...
    WOLFSSL_LOCAL wolf_word32 TimeNowInMilliseconds(void);
#endif
WOLFSSL_LOCAL wolf_word32  LowResTimer(void);
...
#ifdef WOLFSSL_ASYNC_CRYPT
    WOLFSSL_LOCAL int wolfSSL_AsyncInit(WOLFSSL* ssl, WC_ASYNC_DEV* asyncDev, wolf_word32 flags);
