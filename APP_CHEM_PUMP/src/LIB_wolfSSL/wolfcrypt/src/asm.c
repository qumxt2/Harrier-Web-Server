...
static wolf_word32 cpuid_check = 0 ;
static wolf_word32 cpuid_flags = 0 ;

static wolf_word32 cpuid_flag(wolf_word32 leaf, wolf_word32 sub, wolf_word32 num, wolf_word32 bit) {
    int got_intel_cpu = 0;
    int got_amd_cpu = 0;
    unsigned int reg[5];
