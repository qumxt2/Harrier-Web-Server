...
WOLFSSL_LOCAL int GetLength(const byte* input, wolf_word32* inOutIdx, int* len,
                           wolf_word32 maxIdx)
{
...
WOLFSSL_LOCAL int GetLength_ex(const byte* input, wolf_word32* inOutIdx, int* len,
                           wolf_word32 maxIdx, int check)
{
    int     length = 0;
    wolf_word32  idx = *inOutIdx;
    byte    b;
...
static int GetASNHeader_ex(const byte* input, byte tag, wolf_word32* inOutIdx, int* len,
                        wolf_word32 maxIdx, int check)
{
    wolf_word32 idx = *inOutIdx;
    byte   b;
 ...
 */
static int GetASNHeader(const byte* input, byte tag, wolf_word32* inOutIdx, int* len,
                        wolf_word32 maxIdx)
{
...
WOLFSSL_LOCAL int GetSequence(const byte* input, wolf_word32* inOutIdx, int* len,
                           wolf_word32 maxIdx)
{
...
WOLFSSL_LOCAL int GetSequence_ex(const byte* input, wolf_word32* inOutIdx, int* len,
                           wolf_word32 maxIdx, int check)
{
...
WOLFSSL_LOCAL int GetSet(const byte* input, wolf_word32* inOutIdx, int* len,
                        wolf_word32 maxIdx)
{
 ...
 */
static int GetASNNull(const byte* input, wolf_word32* inOutIdx, wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    byte   b;
 ...
 */
static int GetBoolean(const byte* input, wolf_word32* inOutIdx, wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    byte   b;
 ...
 *         Otherwise, the number of bytes in the ASN.1 data.
 */
static int GetOctetString(const byte* input, wolf_word32* inOutIdx, int* len,
                          wolf_word32 maxIdx)
{
 ...
 *         Otherwise, 0 to indicate success.
 */
static int GetASNInt(const byte* input, wolf_word32* inOutIdx, int* len,
                     wolf_word32 maxIdx)
{
    int    ret;
 ...
 */
static int GetInteger7Bit(const byte* input, wolf_word32* inOutIdx, wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    byte   b;
...
WOLFSSL_LOCAL int GetMyVersion(const byte* input, wolf_word32* inOutIdx,
                               int* version, wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
...
int GetShortInt(const byte* input, wolf_word32* inOutIdx, int* number, wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    wolf_word32 len;
...
static int SetShortInt(byte* input, wolf_word32* inOutIdx, wolf_word32 number,
        wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    wolf_word32 len = 0;
...
static int GetExplicitVersion(const byte* input, wolf_word32* inOutIdx, int* version,
                              wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
...
int GetInt(mp_int* mpi, const byte* input, wolf_word32* inOutIdx, wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    int    ret;
    int    length;
...
static int SkipInt(const byte* input, wolf_word32* inOutIdx, wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    int    ret;
    int    length;
...
static int CheckBitString(const byte* input, wolf_word32* inOutIdx, int* len,
                          wolf_word32 maxIdx, int zeroBits, byte* unusedBits)
{
    wolf_word32 idx = *inOutIdx;
    int    length;
    byte   b;
 ...
 * returns the number of bytes added to the buffer.
 */
static wolf_word32 SetBitString(wolf_word32 len, byte unusedBits, byte* output)
{
    wolf_word32 idx = 0;
 ...
 * derSz are NULL.
 */
int wc_BerToDer(const byte* ber, wolf_word32 berSz, byte* der, wolf_word32* derSz)
{
    int ret;
    wolf_word32 i, j, k;
    int len, l;
 ...
 * returns the number of bytes added to the buffer.
 */
static wolf_word32 SetBitString16Bit(word16 val, byte* output)
{
    wolf_word32 idx;
    int    len;
    byte   lastByte;
...
const byte* OidFromId(wolf_word32 id, wolf_word32 type, wolf_word32* oidSz)
{
    const byte* oid = NULL;
...
int EncodeObjectId(const word16* in, wolf_word32 inSz, byte* out, wolf_word32* outSz)
{
    int i, x, len;
    wolf_word32 d, t;
...
int DecodeObjectId(const byte* in, wolf_word32 inSz, word16* out, wolf_word32* outSz)
{
    int x = 0, y = 0;
    wolf_word32 t = 0;
 ...
 *         Otherwise, 0 to indicate success.
 */
int GetASNObjectId(const byte* input, wolf_word32* inOutIdx, int* len,
                          wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    byte   b;
...
int GetObjectId(const byte* input, wolf_word32* inOutIdx, wolf_word32* oid,
                                  wolf_word32 oidType, wolf_word32 maxIdx)
{
    int    ret = 0, length;
    wolf_word32 idx = *inOutIdx;
#ifndef NO_VERIFY_OID
    wolf_word32 actualOidSz = 0;
    ...
    *oid = 0;
    ...
    actualOid = &input[idx];
    if (length > 0)
        actualOidSz = (wolf_word32)length;
#endif /* NO_VERIFY_OID */

    while (length--) {
        /* odd HC08 compiler behavior here when input[idx++] */
        *oid += (wolf_word32)input[idx];
        idx++;
    }
    ...
    *inOutIdx = idx;
...
#ifndef NO_VERIFY_OID
    {
        ...
        if (oidType != oidIgnoreType) {
            ...
            {
                word16 decOid[16];
                wolf_word32 decOidSz = sizeof(decOid);
...
static int SkipObjectId(const byte* input, wolf_word32* inOutIdx, wolf_word32 maxIdx)
{
    wolf_word32 idx = *inOutIdx;
    int    length;
    int ret;
...
WOLFSSL_LOCAL int GetAlgoId(const byte* input, wolf_word32* inOutIdx, wolf_word32* oid,
                     wolf_word32 oidType, wolf_word32 maxIdx)
{
    int    length;
    wolf_word32 idx = *inOutIdx;
...
int wc_RsaPrivateKeyDecode(const byte* input, wolf_word32* inOutIdx, RsaKey* key,
                        wolf_word32 inSz)
{
    int version, length;
...
int ToTraditionalInline_ex(const byte* input, wolf_word32* inOutIdx, wolf_word32 sz,
                           wolf_word32* algId)
{
    wolf_word32 idx;
    int    version, length;
...
int ToTraditionalInline(const byte* input, wolf_word32* inOutIdx, wolf_word32 sz)
{
    wolf_word32 oid;
...
int ToTraditional_ex(byte* input, wolf_word32 sz, wolf_word32* algId)
{
    wolf_word32 inOutIdx = 0;
    int    length;
...
int ToTraditional(byte* input, wolf_word32 sz)
{
    wolf_word32 oid;
...
int wc_GetPkcs8TraditionalOffset(byte* input, wolf_word32* inOutIdx, wolf_word32 sz)
{
    int length;
    wolf_word32 algId;
 ...
 * values.
 */
int wc_CreatePKCS8Key(byte* out, wolf_word32* outSz, byte* key, wolf_word32 keySz,
        int algoID, const byte* curveOID, wolf_word32 oidSz)
{
        wolf_word32 keyIdx = 0;
        wolf_word32 tmpSz  = 0;
        wolf_word32 sz;
...
int wc_CheckPrivateKey(byte* key, wolf_word32 keySz, DecodedCert* der)
{
    int ret;
    (void)keySz;
    ...
    #endif
        wolf_word32   privSz = MAX_ECC_BYTES;
        wolf_word32   keyIdx = 0;
...
int wc_GetKeyOID(byte* key, wolf_word32 keySz, const byte** curveOID, wolf_word32* oidSz,
        int* algoID, void* heap)
{
    wolf_word32 tmpIdx = 0;
 ...
 */
int UnTraditionalEnc(byte* key, wolf_word32 keySz, byte* out, wolf_word32* outSz,
        const char* password, int passwordSz, int vPKCS, int vAlgo,
        byte* salt, wolf_word32 saltSz, int itt, WC_RNG* rng, void* heap)
{
    int algoID = 0;
    byte*  tmp;
    wolf_word32 tmpSz = 0;
 ...
 * decrypted key.)
 */
int TraditionalEnc(byte* key, wolf_word32 keySz, byte* out, wolf_word32* outSz,
        const char* password, int passwordSz, int vPKCS, int vAlgo,
        int encAlgId, byte* salt, wolf_word32 saltSz, int itt, WC_RNG* rng,
        void* heap)
{
    int ret = 0;
    int version, blockSz, id;
    wolf_word32 idx = 0, encIdx;
#ifdef WOLFSSL_SMALL_STACK
    byte* saltTmp = NULL;
#else
    ...
    byte cbcIv[MAX_IV_SIZE];
    byte *pkcs8Key = NULL;
    wolf_word32 pkcs8KeySz, padSz = 0;
    int algId;
    const byte* curveOid = NULL;
    wolf_word32 curveOidSz = 0;
    const byte* pbeOid = NULL;
    wolf_word32 pbeOidSz;
    const byte* encOid = NULL;
    int encOidSz = 0;
    wolf_word32 pbeLen = 0, kdfLen = 0, encLen = 0;
    wolf_word32 innerLen = 0, outerLen;
...
/* Remove Encrypted PKCS8 header, move beginning of traditional to beginning
   of input */
int ToTraditionalEnc(byte* input, wolf_word32 sz,const char* password,
                     int passwordSz, wolf_word32* algId)
{
    wolf_word32 inOutIdx = 0, seqEnd, oid;
 ...
 */
int EncryptContent(byte* input, wolf_word32 inputSz, byte* out, wolf_word32* outSz,
        const char* password, int passwordSz, int vPKCS, int vAlgo,
        byte* salt, wolf_word32 saltSz, int itt, WC_RNG* rng, void* heap)
{
    wolf_word32 sz;
 ...
 */
int DecryptContent(byte* input, wolf_word32 sz,const char* password, int passwordSz)
{
    wolf_word32 inOutIdx = 0, seqEnd, oid;
    int    ret = 0;
...
#ifndef HAVE_USER_RSA
int wc_RsaPublicKeyDecode_ex(const byte* input, wolf_word32* inOutIdx, wolf_word32 inSz,
    const byte** n, wolf_word32* nSz, const byte** e, wolf_word32* eSz)
{
    int ret = 0;
    int length;
...
int wc_RsaPublicKeyDecode(const byte* input, wolf_word32* inOutIdx, RsaKey* key,
                       wolf_word32 inSz)
{
    int ret;
    const byte *n = NULL, *e = NULL;
    wolf_word32 nSz = 0, eSz = 0;
...
int wc_RsaPublicKeyDecodeRaw(const byte* n, wolf_word32 nSz, const byte* e,
                             wolf_word32 eSz, RsaKey* key)
{
...
int wc_DhKeyDecode(const byte* input, wolf_word32* inOutIdx, DhKey* key, wolf_word32 inSz)
{
    int    length;
...
int wc_DhParamsLoad(const byte* input, wolf_word32 inSz, byte* p, wolf_word32* pInOutSz,
                 byte* g, wolf_word32* gInOutSz)
{
    wolf_word32 idx = 0;
    int    ret;
    int    length;
...
int DsaPublicKeyDecode(const byte* input, wolf_word32* inOutIdx, DsaKey* key,
                        wolf_word32 inSz)
{
    int    length;
...
int DsaPrivateKeyDecode(const byte* input, wolf_word32* inOutIdx, DsaKey* key,
                        wolf_word32 inSz)
{
    int    length, version;
...
/* Convert DsaKey key to DER format, write to output (inLen), return bytes
 written */
int wc_DsaKeyToDer(DsaKey* key, byte* output, wolf_word32 inLen)
{
    wolf_word32 seqSz, verSz, rawLen, intTotalLen = 0;
    wolf_word32 sizes[DSA_INTS];
...
void InitDecodedCert(DecodedCert* cert,
                     const byte* source, wolf_word32 inSz, void* heap)
{
    if (cert != NULL) {
...
static int StoreRsaKey(DecodedCert* cert)
{
    ...
    static int CheckCurve(wolf_word32 oid)
    {
        int ret = 0;
        wolf_word32 oidSz = 0;
...
static int GetKey(DecodedCert* cert)
{
    ...
    switch (cert->keyOID) {
        ...
        case NTRUk:
        {
            ...
            word16      keyLen;
            wolf_word32      rc;
            wolf_word32      remaining = cert->maxIdx - cert->srcIdx;
            byte*       publicKey;
#ifdef WOLFSSL_SMALL_STACK
            byte*       keyBlob = NULL;
#else
...
static int GetName(DecodedCert* cert, int nameType)
{
    ...
    while (cert->srcIdx < (wolf_word32)length) {
        byte   b;
        byte   joint[2];
        byte   tooBig = FALSE;
        int    oidSz;
...
int GetAsnTimeString(void* currTime, byte* buf, wolf_word32 len)
{
    struct tm* ts      = NULL;
...
int wc_GetTime(void* timePtr, wolf_word32 timeSize)
{
    ...
    if ((wolf_word32)sizeof(time_t) > timeSize) {
        return BUFFER_E;
    }
...
static int GetDateInfo(const byte* source, wolf_word32* idx, const byte** pDate,
                        byte* pFormat, int* pLength, wolf_word32 maxIdx)
{
    int length;
    byte format;
...
static wolf_word32 SetOctetString8Bit(wolf_word32 len, byte* output)
{
...
static wolf_word32 SetDigest(const byte* digest, wolf_word32 digSz, byte* output)
{
    wolf_word32 idx = SetOctetString8Bit(digSz, output);
...
static wolf_word32 BytePrecision(wolf_word32 value)
{
    wolf_word32 i;
...
WOLFSSL_LOCAL wolf_word32 SetLength(wolf_word32 length, byte* output)
{
    wolf_word32 i = 0, j;
...
WOLFSSL_LOCAL wolf_word32 SetSequence(wolf_word32 len, byte* output)
{
    output[0] = ASN_SEQUENCE | ASN_CONSTRUCTED;
    return SetLength(len, output + 1) + 1;
}

WOLFSSL_LOCAL wolf_word32 SetOctetString(wolf_word32 len, byte* output)
{
    output[0] = ASN_OCTET_STRING;
    return SetLength(len, output + 1) + 1;
}
...
WOLFSSL_LOCAL wolf_word32 SetSet(wolf_word32 len, byte* output)
{
    output[0] = ASN_SET | ASN_CONSTRUCTED;
    return SetLength(len, output + 1) + 1;
}

WOLFSSL_LOCAL wolf_word32 SetImplicit(byte tag, byte number, wolf_word32 len, byte* output)
{
...
WOLFSSL_LOCAL wolf_word32 SetExplicit(byte number, wolf_word32 len, byte* output)
{
...
WOLFSSL_LOCAL wolf_word32 SetAlgoID(int algoOID, byte* output, int type, int curveSz)
{
    wolf_word32 tagSz, idSz, seqSz, algoSz = 0;
...
wolf_word32 wc_EncodeSignature(byte* out, const byte* digest, wolf_word32 digSz,
                          int hashOID)
{
    byte digArray[MAX_ENCODED_DIG_SZ];
    byte algoArray[MAX_ALGO_SZ];
    byte seqArray[MAX_SEQ_SZ];
    wolf_word32 encDigSz, algoSz, seqSz;
...
#ifndef NO_ASN_CRYPT
static int HashForSignature(const byte* buf, wolf_word32 bufSz, wolf_word32 sigOID,
...
static int ConfirmSignature(SignatureCtx* sigCtx,
    const byte* buf, wolf_word32 bufSz,
    const byte* key, wolf_word32 keySz, wolf_word32 keyOID,
    const byte* sig, wolf_word32 sigSz, wolf_word32 sigOID)
{
    int ret = 0;
...
static int Word32ToString(char* d, wolf_word32 number)
{
    int i = 0;

    if (d != NULL) {
        wolf_word32 order = 1000000000;
        wolf_word32 digit;
...
int DecodePolicyOID(char *out, wolf_word32 outSz, const byte *in, wolf_word32 inSz)
{
    wolf_word32 val, idx = 0, nb_bytes;
    size_t w_bytes = 0;
    ...
    while (idx < inSz) {
        ...
        if (!nb_bytes)
            val = (wolf_word32)(in[idx++] & 0x7f);
        else {
            wolf_word32 base = 1, tmp = nb_bytes;

            while (tmp != 0) {
                val += (wolf_word32)(in[idx+tmp] & 0x7f) * base;
                base *= 128;
                tmp--;
            }
            val += (wolf_word32)(in[idx++] & 0x7f) * base;
 ...
 */
int CheckCertSignature(const byte* cert, wolf_word32 certSz, void* heap, void* cm)
{
    ...
    wolf_word32        idx = 0;
    int           len;
    wolf_word32        tbsCertIdx;
    wolf_word32        sigIndex;
    wolf_word32        signatureOID;
    wolf_word32        oid;
    wolf_word32        issuerIdx;
    wolf_word32        issuerSz;
#ifndef NO_SKID
    int           extLen;
    wolf_word32        extIdx;
    wolf_word32        extEndIdx;
...
WOLFSSL_LOCAL int SetMyVersion(wolf_word32 version, byte* output, int header)
{
    int i = 0;
...
WOLFSSL_LOCAL int SetSerialNumber(const byte* sn, wolf_word32 snSz, byte* output,
    int maxSnSz)
{
    int i = 0;
...
WOLFSSL_LOCAL int GetSerialNumber(const byte* input, wolf_word32* inOutIdx,
    byte* serial, int* serialSz, wolf_word32 maxIdx)
{
    int result = 0;
    int ret;
...
int AllocDer(DerBuffer** pDer, wolf_word32 length, int type, void* heap)
{
...
int wc_AllocDer(DerBuffer** pDer, wolf_word32 length, int type, void* heap)
{
...
int wc_EncryptedInfoParse(EncryptedInfo* info, char** pBuffer, size_t bufSz)
{
    ...
    line = XSTRNSTR(bufferStart, kProcTypeHeader,
                    min((wolf_word32)bufSz, PEM_LINE_LEN));
    if (line != NULL) {
        if (line >= bufferEnd) {
            return BUFFER_E;
        }

        lineSz = (wolf_word32)(bufferEnd - line);
        ...
        startSz = (wolf_word32)(bufferEnd - start);
        ...
        if ((start != NULL) && (finish != NULL) && (start < finish)) {
            ...
            finishSz = (wolf_word32)(bufferEnd - finish);
            ...
            if ((newline != NULL) && (newline > finish)) {
                info->ivSz = (wolf_word32)(newline - (finish + 1));
...
int wc_DerToPem(const byte* der, wolf_word32 derSz,
                byte* output, wolf_word32 outSz, int type)
{
...
int wc_DerToPemEx(const byte* der, wolf_word32 derSz, byte* output, wolf_word32 outSz,
             byte *cipher_info, int type)
{
...
#endif
        outLen = 0;
        if ((err = Base64_Encode(der, derSz, NULL, (wolf_word32*)&outLen))
                != LENGTH_ONLY_E) {
            return err;
        }
    ...
    if ( (err = Base64_Encode(der, derSz, output + i, (wolf_word32*)&outLen)) < 0) {
#ifdef WOLFSSL_SMALL_STACK
        XFREE(footer, NULL, DYNAMIC_TYPE_TMP_BUFFER);
#endif
        return err;
              ...
              DerBuffer** pDer, void* heap, EncryptedInfo* info, int* eccKey)
{
    ...
    ret = AllocDer(pDer, (wolf_word32)neededSz, type, heap);
    if (ret < 0) {
        return ret;
    }
    der = *pDer;

    if (Base64_Decode((byte*)headerEnd, (wolf_word32)neededSz,
...
static WC_INLINE int OurPasswordCb(char* passwd, int sz, int rw, void* userdata)
{
    ...
    return min((wolf_word32)sz, (wolf_word32)XSTRLEN((char*)userdata));
}
                        ...
                        unsigned char* buff, int buffSz, const char* pass)
{
    ...
    if (ret < 0) {
        ...
        if (der->length <= (wolf_word32)buffSz) {
...
int wc_PemCertToDer(const char* fileName, unsigned char* derBuf, int derSz)
{
    ...
    if (ret == 0) {
        ...
        if (ret == 0) {
            ...
            if (ret == 0) {
                if (converted->length < (wolf_word32)derSz) {
...
/* Convert RsaKey key to DER format, write to output (inLen), return bytes
   written */
int wc_RsaKeyToDer(RsaKey* key, byte* output, wolf_word32 inLen)
{
    wolf_word32 seqSz, verSz, rawLen, intTotalLen = 0;
    wolf_word32 sizes[RSA_INTS];
    int    i, j, outLen, ret = 0, mpSz;
...
/* Convert Rsa Public key to DER format, write to output (inLen), return bytes
   written */
int wc_RsaKeyToPublicDer(RsaKey* key, byte* output, wolf_word32 inLen)
{
...
/* Write a set header to output */
static wolf_word32 SetUTF8String(wolf_word32 len, byte* output)
{
...
int wc_EccPublicKeyToDer(ecc_key* key, byte* output, wolf_word32 inLen,
                                                              int with_AlgCurve)
{
    wolf_word32 infoSz = 0;
    wolf_word32 keySz  = 0;
    int ret;
...
static int SetEd25519PublicKey(byte* output, ed25519_key* key, int with_header)
{
    ...
    int  bitStringSz;
    int  idx;
    wolf_word32 pubSz = ED25519_PUB_KEY_SIZE;
#ifdef WOLFSSL_SMALL_STACK
    byte* algo = NULL;
    byte* pub = NULL;
#else
...
int wc_Ed25519PublicKeyToDer(ed25519_key* key, byte* output, wolf_word32 inLen,
                                                                    int withAlg)
{
    wolf_word32 infoSz = 0;
    wolf_word32 keySz  = 0;
...
static int SetExtensions(byte* out, wolf_word32 outSz, int *IdxInOut,
                         const byte* ext, int extSz)
{
    if (out == NULL || IdxInOut == NULL || ext == NULL)
        return BAD_FUNC_ARG;

    if (outSz < (wolf_word32)(*IdxInOut+extSz))
        return BUFFER_E;
...
static int SetExtensionsHeader(byte* out, wolf_word32 outSz, int extSz)
{
    ...
    if (outSz < (wolf_word32)(lenSz+seqSz+1))
        return BUFFER_E;
...
static int SetCa(byte* out, wolf_word32 outSz)
{
...
static int SetOidValue(byte* out, wolf_word32 outSz, const byte *oid, wolf_word32 oidSz,
                       byte *in, wolf_word32 inSz)
{
    int idx = 0;
...
static int SetSKID(byte* output, wolf_word32 outSz, const byte *input, wolf_word32 length)
{
 ...
 * RFC5280 : non-critical */
static int SetAKID(byte* output, wolf_word32 outSz,
                                         byte *input, wolf_word32 length, void* heap)
{
    byte    *enc_val;
    int     ret, enc_valSz;
 ...
 * RFC5280 : critical */
static int SetKeyUsage(byte* output, wolf_word32 outSz, word16 input)
{
    byte ku[5];
    int  idx;
...
static int SetOjectIdValue(byte* output, wolf_word32 outSz, int* idx,
    const byte* oid, wolf_word32 oidSz)
{
    /* verify room */
...
static int SetExtKeyUsage(Cert* cert, byte* output, wolf_word32 outSz, byte input)
{
...
static int EncodePolicyOID(byte *out, wolf_word32 *outSz, const char *in, void* heap)
{
    wolf_word32 val, idx = 0, nb_val;
    char *token, *str, *ptr;
    wolf_word32 len;
                                  ...
                                  void* heap)
{
    byte    oid[MAX_OID_SZ],
            ...
            out[MAX_CERTPOL_SZ];
    wolf_word32  oidSz;
    wolf_word32  outSz, i = 0, der_oidSz[MAX_CERTPOL_NB];
    int     ret;
...
static int SetAltNames(byte *out, wolf_word32 outSz, byte *input, wolf_word32 length)
{
...
int SetName(byte* output, wolf_word32 outputSz, CertName* name)
{
    ...
    for (i = 0; i < NAME_ENTRIES; i++) {
        ...
        if (type == ASN_ORGUNIT_NAME) {
            ...
            for (j = 0; j < CTC_MAX_ATTRIB; j++) {
                if (name->name[j].sz > 0 && type == name->name[j].id) {
                    if (outputSz < (wolf_word32)(idx+addNames[j].totalLen)) {
                    #ifdef WOLFSSL_SMALL_STACK
                        XFREE(names, NULL, DYNAMIC_TYPE_TMP_BUFFER);
                    #endif
                        return BUFFER_E;
        ...
        if (names[i].used) {
            if (outputSz < (wolf_word32)(idx+names[i].totalLen)) {
#ifdef WOLFSSL_SMALL_STACK
                XFREE(names, NULL, DYNAMIC_TYPE_TMP_BUFFER);
#endif
                return BUFFER_E;
                      ...
                      ed25519_key* ed25519Key)
{
    ...
    if (XSTRLEN((const char*)cert->sbjRaw) > 0) {
        ...
        der->subjectSz = min(sizeof(der->subject),
                (wolf_word32)XSTRLEN((const char*)cert->sbjRaw));
        /* header */
    ...
    if (XSTRLEN((const char*)cert->issRaw) > 0) {
        ...
        der->issuerSz = min(sizeof(der->issuer),
                (wolf_word32)XSTRLEN((const char*)cert->issRaw));
        /* header */
...
static int MakeAnyCert(Cert* cert, byte* derBuffer, wolf_word32 derSz,
...
int wc_MakeCert_ex(Cert* cert, byte* derBuffer, wolf_word32 derSz, int keyType,
                   void* key, WC_RNG* rng)
{
    RsaKey* rsaKey = NULL;
    ecc_key* eccKey = NULL;
...
/* Make an x509 Certificate v3 RSA or ECC from cert input, write to buffer */
int wc_MakeCert(Cert* cert, byte* derBuffer, wolf_word32 derSz, RsaKey* rsaKey,
...
int wc_MakeNtruCert(Cert* cert, byte* derBuffer, wolf_word32 derSz,
...
static int MakeCertReq(Cert* cert, byte* derBuffer, wolf_word32 derSz,
...
int wc_MakeCertReq_ex(Cert* cert, byte* derBuffer, wolf_word32 derSz, int keyType,
                      void* key)
{
    RsaKey* rsaKey = NULL;
    ecc_key* eccKey = NULL;
...
int wc_MakeCertReq(Cert* cert, byte* derBuffer, wolf_word32 derSz,
...
static int SignCert(int requestSz, int sType, byte* buffer, wolf_word32 buffSz,
                    RsaKey* rsaKey, ecc_key* eccKey, ed25519_key* ed25519Key,
                    WC_RNG* rng)
{
    int sigSz = 0;
...
int wc_SignCert_ex(int requestSz, int sType, byte* buffer, wolf_word32 buffSz,
...
int wc_SignCert(int requestSz, int sType, byte* buffer, wolf_word32 buffSz,
                RsaKey* rsaKey, ecc_key* eccKey, WC_RNG* rng)
{
...
int wc_MakeSelfCert(Cert* cert, byte* buffer, wolf_word32 buffSz,
 ...
 */
int wc_SetExtKeyUsageOID(Cert *cert, const char *in, wolf_word32 sz, byte idx,
        void* heap)
{
    byte oid[MAX_OID_SZ];
    wolf_word32 oidSz = MAX_OID_SZ;
    ...
    if (ret < 0) {
        ...
        if (b != ASN_EXTENSIONS) {
            ...
            while (decoded->srcIdx < maxExtensionsIdx) {
                wolf_word32 oid;
                wolf_word32 startIdx = decoded->srcIdx;
                wolf_word32 tmpIdx;
...
int StoreECC_DSA_Sig(byte* out, wolf_word32* outLen, mp_int* r, mp_int* s)
{
    wolf_word32 idx = 0;
    int    rSz;                           /* encoding size */
    int    sSz;
    wolf_word32 headerSz = 4;   /* 2*ASN_TAG + 2*LEN(ENUM) */
...
int DecodeECC_DSA_Sig(const byte* sig, wolf_word32 sigLen, mp_int* r, mp_int* s)
{
    wolf_word32 idx = 0;
    int    len = 0;
...
int wc_EccPrivateKeyDecode(const byte* input, wolf_word32* inOutIdx, ecc_key* key,
                        wolf_word32 inSz)
{
    wolf_word32 oidSum;
    int    version, length;
...
/* returns 0 on success */
static int ASNToHexString(const byte* input, wolf_word32* inOutIdx, char** out,
                          wolf_word32 inSz, void* heap, int heapType)
{
    int len;
    int i;
    char* str;
...
int wc_EccPublicKeyDecode(const byte* input, wolf_word32* inOutIdx,
                          ecc_key* key, wolf_word32 inSz)
{
    int    length;
    int    ret;
    int    curve_id = ECC_CURVE_DEF;
...
static int wc_BuildEccKeyDer(ecc_key* key, byte* output, wolf_word32 inLen,
                             int pubIn)
{
    ...
    wolf_word32 idx = 0, prvidx = 0, pubidx = 0, curveidx = 0;
    wolf_word32 seqSz, privSz, pubSz = ECC_BUFSIZE;
...
int wc_EccKeyToDer(ecc_key* key, byte* output, wolf_word32 inLen)
{
 ...
 * length on success else < 0 */
int wc_EccPrivateKeyToDer(ecc_key* key, byte* output, wolf_word32 inLen)
{
...
int wc_EccPrivateKeyToPKCS8(ecc_key* key, byte* output, wolf_word32* outLen)
{
    int ret, tmpDerSz;
    int algoID = 0;
    wolf_word32 oidSz = 0;
    wolf_word32 pkcs8Sz = 0;
    const byte* curveOID = NULL;
    byte* tmpDer = NULL;
...
int wc_Ed25519PrivateKeyDecode(const byte* input, wolf_word32* inOutIdx,
                               ed25519_key* key, wolf_word32 inSz)
{
    wolf_word32      oid;
...
int wc_Ed25519PublicKeyDecode(const byte* input, wolf_word32* inOutIdx,
                              ed25519_key* key, wolf_word32 inSz)
{
    int    length;
    int    ret;
 ...
 * return length on success, negative on error */
static int wc_BuildEd25519KeyDer(ed25519_key* key, byte* output, wolf_word32 inLen,
                                 int pubOut)
{
    byte   algoArray[MAX_ALGO_SZ];
    byte   ver[MAX_VERSION_SZ];
    byte   seq[MAX_SEQ_SZ];
    int    ret;
    wolf_word32 idx = 0, seqSz, verSz, algoSz, privSz, pubSz = 0;
...
/* Write a Private ecc key, including public to DER format,
 * length on success else < 0 */
int wc_Ed25519KeyToDer(ed25519_key* key, byte* output, wolf_word32 inLen)
{
...
/* Write only private ecc key to DER format,
 * length on success else < 0 */
int wc_Ed25519PrivateKeyToDer(ed25519_key* key, byte* output, wolf_word32 inLen)
{
...
static int GetBasicDate(const byte* source, wolf_word32* idx, byte* date,
...
static int GetEnumerated(const byte* input, wolf_word32* inOutIdx, int *value)
{
    wolf_word32 idx = *inOutIdx;
    wolf_word32 len;
...
static int DecodeSingleResponse(byte* source,
                            wolf_word32* ioIndex, OcspResponse* resp, wolf_word32 size)
{
    wolf_word32 idx = *ioIndex, prevIndex, oid;
...
static int DecodeOcspRespExtensions(byte* source,
                            wolf_word32* ioIndex, OcspResponse* resp, wolf_word32 sz)
{
    wolf_word32 idx = *ioIndex;
    int length;
    ...
    while (idx < (wolf_word32)ext_bound) {
        if (GetSequence(source, &idx, &length, sz) < 0) {
            WOLFSSL_MSG("\tfail: should be a SEQUENCE");
            return ASN_PARSE_E;
        }
...
static int DecodeResponseData(byte* source,
                            wolf_word32* ioIndex, OcspResponse* resp, wolf_word32 size)
{
    wolf_word32 idx = *ioIndex, prev_idx;
    int length;
    int version;
    wolf_word32 responderId = 0;
...
static int DecodeBasicOcspResponse(byte* source, wolf_word32* ioIndex,
            OcspResponse* resp, wolf_word32 size, void* cm, void* heap, int noVerify)
{
    int    length;
    wolf_word32 idx = *ioIndex;
    wolf_word32 end_index;
    int    ret;
    int    sigLength;
...
wolf_word32 EncodeOcspRequestExtensions(OcspRequest* req, byte* output, wolf_word32 size)
{
    static const byte NonceObjId[] = { 0x2b, 0x06, 0x01, 0x05, 0x05, 0x07,
                                       0x30, 0x01, 0x02 };
    byte seqArray[5][MAX_SEQ_SZ];
    wolf_word32 seqSz[5], totalSz = (wolf_word32)sizeof(NonceObjId);
    ...
    totalSz += (wolf_word32)sizeof(NonceObjId);
...
int EncodeOcspRequest(OcspRequest* req, byte* output, wolf_word32 size)
{
    byte seqArray[5][MAX_SEQ_SZ];
    ...
    wolf_word32 seqSz[5], algoSz, issuerSz, issuerKeySz, extSz, totalSz;
    int i, snSz;
...
WOLFSSL_LOCAL int GetNameHash(const byte* source, wolf_word32* idx, byte* hash,
                             int maxIdx)
{
    int    length;  /* length of all distinguished names */
    int    ret;
...
static int GetRevoked(const byte* buff, wolf_word32* idx, DecodedCRL* dcrl,
                      int maxIdx)
{
    int    ret, len;
    wolf_word32 end;
...
static int GetCRL_Signature(const byte* source, wolf_word32* idx, DecodedCRL* dcrl,
                            int maxIdx)
{
    int    length;
    int    ret;
...
int VerifyCRL_Signature(SignatureCtx* sigCtx, const byte* toBeSigned,
                        wolf_word32 tbsSz, const byte* signature, wolf_word32 sigSz,
                        wolf_word32 signatureOID, Signer *ca, void* heap)
{
    /* try to confirm/verify signature */
...
int ParseCRL(DecodedCRL* dcrl, const byte* buff, wolf_word32 sz, void* cm)
{
    int          version, len, doNextDate = 1;
    wolf_word32       oid, idx = 0, dateIdx;
    Signer*      ca = NULL;
    SignatureCtx sigCtx;
...
int wc_ParseCertPIV(wc_CertPIV* piv, const byte* buf, wolf_word32 totalSz)
{
    int length = 0;
    wolf_word32 idx = 0;
