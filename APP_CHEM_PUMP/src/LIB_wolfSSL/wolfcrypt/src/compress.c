 ...
 */
int wc_Compress_ex(byte* out, wolf_word32 outSz, const byte* in, wolf_word32 inSz,
    wolf_word32 flags, wolf_word32 windowBits)
{
    z_stream stream;
    int result = 0;
...
int wc_Compress(byte* out, wolf_word32 outSz, const byte* in, wolf_word32 inSz, wolf_word32 flags)
{
...
*/
int wc_DeCompress_ex(byte* out, wolf_word32 outSz, const byte* in, wolf_word32 inSz,
    int windowBits)
/*
 * out - pointer to destination buffer
 * outSz - size of destination buffer
...
int wc_DeCompress(byte* out, wolf_word32 outSz, const byte* in, wolf_word32 inSz)
{
