 ...
 * returns 0 on success, negative upon failure
 */
int wc_DsaExportParamsRaw(DsaKey* dsa, byte* p, wolf_word32* pSz,
                          byte* q, wolf_word32* qSz, byte* g, wolf_word32* gSz)
{
    int err;
    wolf_word32 pLen, qLen, gLen;
 ...
 * returns 0 on success, negative upon failure
 */
int wc_DsaExportKeyRaw(DsaKey* dsa, byte* x, wolf_word32* xSz, byte* y, wolf_word32* ySz)
{
    int err;
    wolf_word32 xLen, yLen;
