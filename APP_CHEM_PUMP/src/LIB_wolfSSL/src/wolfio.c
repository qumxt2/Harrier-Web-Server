...
{
    wolf_word32 reqTypeLen, domainNameLen, reqSzStrLen, contentTypeLen, maxLen;
    char reqSzStr[6];
    char* req = (char*)buf;
    const char* blankStr = " ";
    ...
    wolf_word32 blankStrLen, http11StrLen, hostStrLen, contentLenStrLen,
        contentTypeStrLen, doubleCrLfStrLen;

    reqTypeLen = (wolf_word32)XSTRLEN(reqType);
    domainNameLen = (wolf_word32)XSTRLEN(domainName);
    reqSzStrLen = wolfIO_Word16ToString(reqSzStr, (word16)reqSz);
    contentTypeLen = (wolf_word32)XSTRLEN(contentType);

    blankStrLen = (wolf_word32)XSTRLEN(blankStr);
    http11StrLen = (wolf_word32)XSTRLEN(http11Str);
    hostStrLen = (wolf_word32)XSTRLEN(hostStr);
    contentLenStrLen = (wolf_word32)XSTRLEN(contentLenStr);
    contentTypeStrLen = (wolf_word32)XSTRLEN(contentTypeStr);
    doubleCrLfStrLen = (wolf_word32)XSTRLEN(doubleCrLfStr);
