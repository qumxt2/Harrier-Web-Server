...
// This function will invert a rectangular screen area, black -> white and white -> black, 
...
uint8 invertArea (uint8 xUpperLeft, uint8 yUpperLeft, uint8 xLowerRight, uint8 yLowerRight)
{
	...
	// Driver library function to invert the screen area
	ginvertvp(xUpperLeft, yUpperLeft, xLowerRight, yLowerRight);
