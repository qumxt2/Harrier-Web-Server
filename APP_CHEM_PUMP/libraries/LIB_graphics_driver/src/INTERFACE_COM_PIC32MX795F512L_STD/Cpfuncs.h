...
// BKC 6/26/08 - The "noreturn" attribute was added to the following function.
// This was done in order to maximize the ammount of usable RAM available to
// GCA applications.  This keeps information from being pushed onto the stack
// that will never be accessed again.  Refer to bug #2829 for more information.
void K_OS_Start(void) __attribute__ ((noreturn));	/* enter CMX OS */
...
// GCA applications.  This keeps information from being pushed onto the stack
// that will never be accessed again.  Refer to bug #2829 for more information.
void K_I_Scheduler(void) __attribute__ ((noreturn));	/* enter K_I_Scheduler, called by K_OS_Start */
