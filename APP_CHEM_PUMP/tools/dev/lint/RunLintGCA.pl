...
foreach $item (@interfaceFiles)
{
	if ($item =~ /PIC24HJ256GP610/)
	{
		...
		$lintOptionsFiles = '"C:\\GCA2\\TOOLS\\lint\\GCA_Options.lnt" "interfaceList.lnt" -i"..\\..\\..\\src"';
	}
	...
	elsif ($item =~ /PIC32MX795F512L/)
	{
		...
		$lintOptionsFiles = '"C:\\GCA2\\TOOLS\\lint\\GCA_Options_PIC32.lnt" "interfaceList.lnt" -i"..\\..\\..\\src"';
	}
	elsif ($item =~ /PIC18F4685/)
	{
		$processorDefine = "-d__PIC18F4685__";
		$lintOptionsFiles = '"C:\\GCA2\\TOOLS\\lint\\GCA_Options_PIC18.lnt" "interfaceList.lnt" -i"..\\..\\..\\src"';
	}
}
