...
def add_tos_placeholder(apps, schema_editor):
    '''Add a placeholder terms-of-service'''
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gracopumpapp', '0075_auto_20150707_1105'),
    ]

    operations = [
        migrations.RunPython(add_tos_placeholder)
    ]
